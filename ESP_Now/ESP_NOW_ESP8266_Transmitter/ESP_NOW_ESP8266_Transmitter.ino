...
void ScanForSlave() {
  ...
  if (scanResults == 0) {
    ...
    for (int i = 0; i < scanResults; ++i) {
      ...
      delay(10);
      // Check if the current device starts with <code data-enlighter-language="raw" class="EnlighterJSRAW">Slave</code>
...
void loop() {
  ...
  ScanForSlave();
  // If Slave is found, it would be populate in <code data-enlighter-language="raw" class="EnlighterJSRAW">slave</code> variable
  // We will check if <code data-enlighter-language="raw" class="EnlighterJSRAW">slave</code> is defined and then we proceed further
  if (SlaveCnt > 0) { // check if slave channel is defined
    // <code data-enlighter-language="raw" class="EnlighterJSRAW">slave</code> is defined
